...
filenames <- c("/home/rmhawwo/Scratch/batch3_admera/batch3_RNA_alignment/250umB.dedup.bam")
...
saveRDS(se, file = "/home/rmhawwo/Scratch/batch3_admera/batch3_RNA_alignment/summarizedExperiment_08Nov2018_250umB_dedup.rds")
