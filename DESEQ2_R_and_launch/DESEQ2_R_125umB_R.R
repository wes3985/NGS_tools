...
filenames <- c("/home/rmhawwo/Scratch/batch3_admera/batch3_RNA_alignment/125umB.dedup.bam")
...
saveRDS(se, file = "/home/rmhawwo/Scratch/batch3_admera/batch3_RNA_alignment/summarizedExperiment_08Nov2018_125umB_dedup.rds")
