...
filenames <- c("/home/rmhawwo/Scratch/batch3_admera/batch3_RNA_alignment/70umB.dedup.bam")
...
saveRDS(se, file = "/home/rmhawwo/Scratch/batch3_admera/batch3_RNA_alignment/summarizedExperiment_08Nov2018_70umB_dedup.rds")
