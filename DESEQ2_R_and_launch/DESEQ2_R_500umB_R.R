...
filenames <- c("/home/rmhawwo/Scratch/batch3_admera/batch3_RNA_alignment/500umB.dedup.bam")
...
saveRDS(se, file = "/home/rmhawwo/Scratch/batch3_admera/batch3_RNA_alignment/summarizedExperiment_08Nov2018_500umB_dedup.rds")
