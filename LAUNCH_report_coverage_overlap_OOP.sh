...
# qsub $HOME/Scratch/git_single_cell_sequencing_scripts/LAUNCH_report_coverage_overlap_OOP.sh $HOME/Scratch/merged_bam_analysis/coverage_test_file_100k.txt "2" "AE,BE,HE,C" 
$HOME/Scratch/merged_bam_analysis/coverage_test_file_100k_OUTPUT.txt
